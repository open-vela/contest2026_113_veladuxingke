...
/**
 * Static-prompt LLM response cache — 8-slot LRU with TTL.
 *
...
/**
 * Return true only for context-free greetings and thanks. Confirmations and
 * dynamic requests (sensor values, reminders, files, searches, and tool
 * operations) must always reach the agent/tool loop.
 */
