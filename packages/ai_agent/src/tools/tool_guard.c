...
static const tool_sec_entry_t s_sec_table[] = {
    ...
    { "routine_schedule_update", TOOL_SEC_SENSITIVE },
...
/* One rate state per sensitive tool (including routine template updates). */
#define SENSITIVE_TOOL_COUNT 4

static const char *s_sensitive_names[SENSITIVE_TOOL_COUNT] = {
    "run_shell", "write_file", "edit_file", "routine_schedule_update"
};
