...
static void cmd_help(void)
{
    printf(
        ...
        "  set_llm <preset|host> [model] [key] - Switch LLM backend (mimo/kimi/qwen/deepseek/glm/openai)\n"
        ...
        "  router_set <preset> <key> - Add LLM backend (mimo/deepseek/kimi/qwen/openai...)\n"
